...
internal val filledDescription: ImageVector
  get() {
    if (_filledDescription != null) {
      return _filledDescription!!
    }
    _filledDescription =
      ImageVector.Builder(
          name = "description",
...
internal var _filledDescription: ImageVector? = null

@Suppress("CheckReturnValue")
internal val outlinedDescription: ImageVector
  get() {
    if (_outlinedDescription != null) {
      return _outlinedDescription!!
    }
    _outlinedDescription =
      ImageVector.Builder(
          name = "description",
          defaultWidth = 24.dp,
          defaultHeight = 24.dp,
...
internal var _outlinedDescription: ImageVector? = null
